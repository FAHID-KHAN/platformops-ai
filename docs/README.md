...
This folder contains the product documentation for PlatformOps AI.
...
- [Open-source architecture and homelab validation plan](architecture/source/open-source-architecture-and-homelab-validation.md)
